...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                String link="http://athena.ecs.csus.edu/~cafekit/cafeKit/login.php";

                String data  = URLEncoder.encode("username","UTF-8") + "=" + URLEncoder.encode(mEmail, "UTF-8");

                //data+="&"+ URLEncoder.encode("username","UTF-8") + "=" + URLEncoder.encode(mEmail, "UTF-8");
                Log.i("test", mEmail);
...
Log.i("test","before read");
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                //Take you to the functionActivity
                Intent intent= new Intent(LoginActivity.this, Functions.class);
